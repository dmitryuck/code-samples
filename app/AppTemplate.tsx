...
export class AppTemplate extends React.Component<Props, State> {
    ...
    componentDidMount() {
        ...
        /*if (isBrowser) {
            ...
            s.innerHTML = `window.__PRELOADED_STATE__ = ${JSON.stringify(this.props.state)}`;
            ...
            <html lang="en-us">
                <head>
                    ...
                    */}
                    ...
                    <link href="assets/css/styles.app.css" rel="stylesheet" media="screen" />
